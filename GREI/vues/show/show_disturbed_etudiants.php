<h2>Liste des étudiants concernés par les perturbations</h2>
<br/>
<center>
<form method="post">
...
<?php
  ...
  $unControleur -> setTable("Vue_Etudiant_Retard_Perturbation_SansBillet");
  $filtre = ""; 
